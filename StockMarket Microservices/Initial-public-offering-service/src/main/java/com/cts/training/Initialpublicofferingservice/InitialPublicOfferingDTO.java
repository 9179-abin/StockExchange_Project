...
public class InitialPublicOfferingDTO {
	@Id
	@GeneratedValue
	private int id;
	...
	public InitialPublicOfferingDTO() {}
	
	

	public InitialPublicOfferingDTO(int id, String companyName, String stockExchange, double priceShare, long noOfShares, String address,
